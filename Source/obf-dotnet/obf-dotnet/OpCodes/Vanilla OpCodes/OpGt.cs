...
namespace Obfuscator.Obfuscation.OpCodes
{
    ...
    {
        public override bool IsInstruction(Instruction Instruction) => ((Instruction.OpCode == OpCode.OpLt) && (Instruction.A != 0) && (!(Instruction.IsConstantB)) && (!(Instruction.IsConstantC)));
